...
if ( isset( $_POST['submit'] ) ) {
	...
	// 		$address = ucwords($address);
			...
			$query = "INSERT INTO students (id, roll, fname, username, sex, email, password, class, sec, dob, doa, address, contact, status) VALUES (NULL, '$roll', '$fname', '$username', '$sex', '$email', '$password', '$class', '$sec', '$dob', '$doa', '$address', '$contact', '1' )";
			...
			if ($result) {
				...
				$message = 'Operation Failed!'.mysqli_error($link);
			}
